export default {
  ffxivCrafting: {
    ...
    show: true,
    tags: ['vue', 'sass', 'api', 'axios', 'search', 'gaming', 'github pages'],
    title: 'FFXIV Crafting',
    wip: false
  },
  githubSavedFilters: {
    description: 'Chrome Extension, to create, save, edit, pin, search and delete filters that you commonly use on the Github Issues and Pull Requests pages.',
    links: {
  ...
  mongoExpressApi: {
    description: 'Simple boilerplate for me to create Apis for my existing and future projects.',
    links: {
      github: 'https://github.com/EmilyRosina/MongoExpressApi'
    },
    show: true,
    tags: ['api', 'mongodb', 'express', 'node'],
  ...
  octopusLabsChallenge: {
    ...
    show: false,
    tags: ['react', 'sass', 'api', 'axios', 'search', 'local storage', 'session storage', 'github pages'],
  ...
  pokedex: {
    ...
    show: true,
    tags: ['vue', 'sass', 'api', 'axios', 'github pages'],
    title: 'Pokedex',
    wip: false
  },
  recipeApi: {
    ...
    show: true,
    tags: ['jquery', 'bootstrap', 'css', 'vanilla js', 'api', 'axios'],
    title: 'Recipe API',
    wip: false
  },
  shoelaceVue: {
    ...
    show: true,
    tags: ['vue', 'sass', 'vue plugin', 'shoelace', 'npm registry', 'github pages'],
    title: 'Shoelace-Vue',
    wip: false
  },
  userStoryBuilder: {
    ...
    show: true,
    tags: ['vue', 'sass', 'local storage', 'github pages'],
  ...
  vueFirebaseLogin: {
    ...
    show: true,
    tags: ['vue', 'firebase', 'sass', 'authentication'],
